...
<div class="wrapper">
    ...
    <div class="image-container2">
        <div class="sub_page_spacing">
            ...
            <div class="general fade-in tab_me">
                <h3>Overall, based purely on our data sources, it would seem that more spending by a country and households on healthcare corresponds
                to a higher rate of cardiovascular death. The country data would seem to be skewed, as there is some heavy error with specific countries such
                as Japan and France. Data on households seems to be consistent with other studies...particularly in the case of affording preventative medications.
                More spending in general seemed to be indicative of a lower risk of death by homicide and vehicular accidents. Public spending on infrastructure and
                individual healthcare makes sense, as there would be more accessability to life saving treatments. Individual spendings may be indicative of more availability
                to spend money on healthcare and again be indicative of more accessability to life saving treatments or hospitals in drastic cases.</h3>
